...
const TECH_ITEMS = [
  ...
  { label: 'React + TypeScript', bg: '#0d1b2a' },
  { label: 'IBM Watson Studio', bg: '#1a1229' },
  { label: 'Python & AsyncIO', bg: '#0a1628' },
  { label: 'Quantum Computing', bg: '#1a0a1a' },
  ...
  { label: 'IT Support & HW', bg: '#1a1520' },
  { label: 'IBM Quantum', bg: '#0f1a2e' },
  { label: 'Cisco NetAcad', bg: '#1a100a' },
  ...
  { label: 'GSAP ScrollTrigger', bg: '#1a1a10' },
  { label: 'Framer Motion', bg: '#100a1a' },
