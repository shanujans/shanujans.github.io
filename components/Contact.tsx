              ...
              <div className="flex flex-col gap-6">
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed">
                    Always open to discussing new opportunities, collaborations, or projects.
                    Whether it's IT Support, AI Tools, or just a conversation — feel free to reach out.
                  </p>
                </div>

                {/* CV Download — HR only */}
                <button onClick={() => setCvModalOpen(true)}
                  className="flex items-center gap-4 p-4 rounded-xl border border-[#7700ff]/30 bg-[#7700ff]/5 hover:border-[#7700ff]/60 transition-all duration-300 group text-left"
                  style={{ boxShadow: '0 0 20px rgba(119,0,255,0.05)' }}>
                  <div className="w-12 h-12 rounded-lg bg-[#7700ff]/10 border border-[#7700ff]/20 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                    <i className="fas fa-file-user text-[#7700ff]" />
                  </div>
                  <div className="flex-1">
                    <div className="text-white font-bold text-sm">Request My CV</div>
                    <div className="text-gray-500 text-xs font-jetbrains-mono mt-0.5">
                      HR & recruiters only — work email + verification required
                    </div>
                  </div>
                  <i className="fas fa-shield-halved text-[#7700ff]/50 group-hover:text-[#7700ff] transition-colors" />
                </button>
                ...
                <button onClick={handleCopy}
                  ...
                  <div className="flex-1">
                    ...
                    <div className="font-jetbrains-mono text-sm text-white tracking-wider select-none">s••••••••@gmail.com</div>
                    <div className={`text-xs mt-0.5 transition-colors ${copied ? 'text-[#00ff9d]' : 'text-gray-600'}`}>
