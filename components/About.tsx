        ...
        <AnimFade delay={100}>
          <div className="max-w-3xl mx-auto mb-16 p-8 rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm">
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              ...
              with hardware, software, networking, and day-to-day technical issues. I'm currently studying
              BSc Computer Science at University of the People (from 2025) while actively building skills in
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              ...
              I'm targeting roles in IT Support, Service Desk, QA Testing, or AI Tools where I can contribute
            ...
            <div className="mt-6 p-4 rounded-lg border border-[#00ff9d]/30 bg-[#00ff9d]/5 flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-gray-400 text-sm">
                  I built and deployed ARIA using Google Gemini API, Cloudflare Workers for secure API proxying,
                  and React. This is my most concrete proof of AI tools experience. Click the 🤖 button to try it.
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto">
          <AnimFade delay={150}>
            <div>
              ...
              <div className="space-y-3">
                {canDoNow.map(s => (
                  <div key={s.label} className="flex items-start gap-3 p-3 rounded-lg border border-white/10 bg-white/5 hover:border-[#00ff9d]/30 transition-all duration-300">
          ...
          <AnimFade delay={250}>
            <div>
              ...
              <div className="space-y-3">
                {learning.map(s => (
                  <div key={s.label} className="flex items-start gap-3 p-3 rounded-lg border border-white/10 bg-white/5 hover:border-[#00b3ff]/30 transition-all duration-300">
