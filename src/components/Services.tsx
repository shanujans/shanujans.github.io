...
const services: Service[] = [
    ...
    { icon: 'fas fa-code', title: 'Web & Bot Development', description: 'Crafting responsive, high-performance websites and intelligent, automated Telegram bots using modern technologies like Python and React.' },
...
const ServiceCard: React.FC<{ service: Service }> = ({ service }) => {
    return (
        <div className="group service-card bg-white/5 backdrop-blur-md p-8 rounded-lg border border-white/10 transition-all duration-300 hover:-translate-y-2">
...
const Services: React.FC = () => {
    return (
        <section id="services" className="py-24 bg-black/20 scroll-mt-24">
